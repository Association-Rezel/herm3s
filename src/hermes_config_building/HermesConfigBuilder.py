#import UCICommon as UCI
import hermes_config_building.UCICommon as UCI #to import from communication_deamon
...
class HermesAC2350DefaultConfig(HermesDefaultConfig):
    ...
    def __init__(self, dns_servers:UCI.DnsServers):
        ...
        self.management = UCI.UCINoIPInterface(
            UCI.UCISectionName("management"),
            UCI.UCISimpleDevice("eth0.65"))
...
class HermesMainUser(HermesConfigBuilder):
    ...
    def __init__(
        ...
        self.firewall_commands.append(UCI.UCIZone(
            network = self.lan_int,
...
class HermesSecondaryUser(HermesMainUser):
